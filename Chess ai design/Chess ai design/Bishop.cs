...
namespace Chess_ai_design
{
    class Bishop:ChessPiece
    {
        ...
        public Bishop(string name, string colour)
        {
            Name = name;
            Colour = colour;
        }
        ...
        {
            if (Colour == "W")
            { PieceImage = @"\\pfa.education\utccstudentusers$\17U-MMaciak\Desktop\Chess Game Ai\ChessGame-AI-\Chess Pieces\White Bishop"; }//--file name--///
            if (Colour == "B")
            { PieceImage = @"\\pfa.education\utccstudentusers$\17U-MMaciak\Desktop\Chess Game Ai\ChessGame-AI-\Chess Pieces\Black Bishop"; }//--file name--///
            return PieceImage;
        }
