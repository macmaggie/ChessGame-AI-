...
namespace Chess_ai_design
{
    class King:ChessPiece
    {
        ...
        {
            if (Colour == "W")
            { PieceImage = @"Desktop\Chess Game Ai\ChessGame-AI-\Chess Pieces\White King.png"; }//--file name--///
            if (Colour == "B")
            { PieceImage = @"Desktop\Chess Game Ai\ChessGame-AI-\Chess Pieces\Black King.png"; }//--file name--///
            return PieceImage;
        }
