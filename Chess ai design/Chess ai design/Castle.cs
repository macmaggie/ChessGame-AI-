...
namespace Chess_ai_design
{
    class Castle:ChessPiece
    {
        ...
        {
            if (Colour == "W")
            { PieceImage = @"\\pfa.education\utccstudentusers$\17U-MMaciak\Desktop\Chess Game Ai\ChessGame-AI-\Chess Pieces\White Castle"; }//--file name--///
            if (Colour == "B")
            { PieceImage = @"\\pfa.education\utccstudentusers$\17U-MMaciak\Desktop\Chess Game Ai\ChessGame-AI-\Chess Pieces\Black Castle"; }//--file name--///
            return PieceImage;
        }
